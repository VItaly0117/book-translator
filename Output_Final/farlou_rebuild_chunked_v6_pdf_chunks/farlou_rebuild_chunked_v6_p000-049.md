...
$$
u_t \equiv \frac{\partial u}{\partial t}, \quad
u_x \equiv \frac{\partial u}{\partial x}, \quad
...
$$
\begin{cases}
\text{вытекающий поток тепла при } x=0 \text{ равен } k \frac{\partial u}{\partial x}, \\
\text{вытекающий поток тепла при } x=L \text{ равен } -k \frac{\partial u}{\partial x},
\end{cases}
$$
...
$$
u(x, 0) = 1, \quad 0 \le x \le 1.
$$

(Зверніть увагу, що ця проблема фізично не має значення, оскільки припускається, що температура на кінцях стрижня миттєво знижується з одного до нуля до $\phi(x)$.
