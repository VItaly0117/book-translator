...
залежать від $x$ і $t$, то швидкість поширення змінюється і вздовж потоку, і в часі, тому початкова крива може істотно деформуватися. Тут справді виникає пряма аналогія з конвекцією.

Розв'язок рівняння першого порядку спирається на той фізичний факт, що початкове збурення в точці $x$ переноситься у площину $(x,t)$ уздовж прямої, яку називають характеристикою (див. рис. 27.1).

Таким чином, хвильова задача істотно відрізняється від рівняння теплопровідності $u_t = u_{xx}$, для якого початкове значення в точці $x$ впливає на розв'язок у всіх точках простору і в будь-який момент часу.
...
Початкове збурення струни в точці $x$ впливає на розв'язок уздовж двох характеристичних ліній у площині $(x,t)$, що відповідають двом хвилям, які рухаються в протилежних напрямках (див. рис. 27.2).
...
6 Використовуючи формули, наведені в тексті, розв'яжіть систему алгебраїчних рівнянь (39.5).
...
Питання хороше, і відповідь на нього залежить від того, що ми хочемо зробити з цим рішенням далі. Однак кожен тип рішення має очевидні переваги.
