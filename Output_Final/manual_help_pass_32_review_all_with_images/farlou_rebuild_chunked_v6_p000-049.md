...
1. Метод розділення змін. Рівень із факторами, що залежать від незалежної заміни, можна знизити до n значущого

диференціальні<sup>рівняння 1</sup>).

2. Метод інтегрованого відпочинку. Рівень прийому незалежних (n-1) незалежних замінників зводиться до рівня відносної (n-1) незалежної заміни; По-друге, рівень із частковими та незалежними змінами можна привести до високого диференціального рівня $^2$ ).
...
РИСУНОК 5.2 Графік функції X(x)T(t) у різних точках на годині t.
...
Найпростіші функції. Особливий тип здатності лежати в таборі кобів. Фіг. Рисунок 5.3 показує графіки кількості таких фундаментальних функцій
...
Ця сила чітко показана на рис. 5.4, як показувати графіки діяльності функцій системи.
...
РИСУНОК 5.4. Неперервність ортогональних функцій
...
Повний розв'язок розташований близько до першого члена, який є першою частиною синусоїди, який гасне в годину (рис. 1). 5.5.)
...
Щоб поділити метод ділення змін на застійні, прикордонні методи наступної лінії та односторонні, tobto mati viglyad
...
Складна природа цих завдань полягає в тому, що гетерогенні пограничні розуми не дозволяють метод розділення взаємозамінних. Однак очевидно, що з $t \to \infty$ з'єднаннями можливо наблизитися до стаціонарного лінійного температурного профілю. Ось чому природно жартувати, маючи на очах сумі нерухомих і тимчасових частин:
...
Фіг. 6.1. Розробка завдань (6.3) одночасно:
a) Температура Покоба $u(x,0)=\varphi(x)$ ;
b) статичної температури $u(x,\infty)=k_1+\frac{x}{L}(k_2-k_1)$ ;
в) температура перевищує температуру.
...
Ви також можете перекласти цей umovi у zero borderline umovi, вікористичний метод, описи в іншому застосуванні. Зазвичай правило буде гетерогенним.
...
Метод, описи в іншому застосуванні, щоб навести на початок форму розвитку задачі:
...
Оскільки це було бачення, мета лекції — розробити завдання поділу змін. Ви можете скористатися цим методом самостійного читання своєї проблеми. Тепер я можу перенести метод цієї лекції заради влади.
...
Дивіться показання на рис. 7.1. Припускається, що верхня вершина стрижа буде відрегульована при нульовій температурі, тобто u(0, t) = 0, а нижня температура води стане нулем (для кожної змінної вона дорівнює нулю P і s