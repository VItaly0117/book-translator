...
то определяются начальные условия для функции  U_$n\left(t\right)$  , т. е.
...
Іншими словами, для різних коефіцієнтів D ми отримаємо різні криві $u\left(x_{0},\ t\right)$ , і тому значення D потрібно вибрати так, щоб розв'язок рівняння відповідав досвіду. У своєму експерименті Ходжкін і Кейсі виявили, що коефіцієнт дифузії $(K^{+})$ іонів в екзоплазмі становить $D=1.5\times10^{-5}$ см²/с.

# ЗАДАЧИ

- 1. Який експеримент ви б порадили для оцінки параметра α у задачі (40.1), якщо у вас є аналітичне рішення, наприклад (40.2)?
- 2. У методі найменших квадратів сума квадратів відхилень кривої від експериментальних точок мінімізується. Наприклад, згідно з методом найменших квадратів, пряма $y(x)$ = a + bx мінімізує (див. рисунок 40.4) функцію
...
$u_t = \alpha^2 u_{xx} u_t = \alpha^2 u_{xx} - hu_x u_t = \alpha^2 u_{xx} - ku u_t = \a$lpha^2 $u_{xx}$ + $f(x, t)$ Уравнение одномерной диффузии Уравнение конвективной диффузии
